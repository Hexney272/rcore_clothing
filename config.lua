...
Config = {
    ...
    EnableClearPed = false,

    CharCreatorApplyRandom = false, -- If true, new players will have slightly randomized appearance when first joining
    ...
    TargetScript = 0,           -- [ 0 = None - using real_markers ]

    -- real_markers rendszer használata (ensure real_markers a server.cfg-ben!)
    UseRealMarkers = true,
